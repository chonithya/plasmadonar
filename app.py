...
@app.route('/stats')
def stats():
    url = "https://mb01e395of.execute-api.us-east-2.amazonaws.com/plasma/getbloodgroupsdata"
    response = requests.get(url)
    r = response.json()
    print("r is ")
    print(r)
...
def requested():
    ...
    print(address)
    url = "https://mb01e395of.execute-api.us-east-2.amazonaws.com/plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
